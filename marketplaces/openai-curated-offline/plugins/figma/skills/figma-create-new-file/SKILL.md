...
If this workflow requires an account-backed connector, use the installed app/connector for Figma. If authorization is missing, ask the user to connect Figma before taking account actions.
